...
struct CudaTri {
    float x0, y0; // Screen-space X and Y for vertex 0 (in pixels)
    float x1, y1; // Screen-space X and Y for vertex 1 (in pixels)
    float x2, y2; // Screen-space X and Y for vertex 2 (in pixels)
    float z0, z1, z2; // Depth values for each vertex (after projection to normalized device coords)
};
